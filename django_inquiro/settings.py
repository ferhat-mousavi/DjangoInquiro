"""
Django settings for django_inquiro project.
...
SECRET_KEY = 'django-insecure-o*h16$7#sz&-(k52tq!)#hldbq5#)i1*$_2t_ta)lar$ad+2l^'
...
WSGI_APPLICATION = 'django_inquiro.wsgi.application'
